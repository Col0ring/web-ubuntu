...
import { AppConfig, OpenedAppConfig, UbuntuApp } from '@/typings/app'
    ...
    (state) => [
      {
        ...
        openApp(id: string, app: AppConfig) {
          if (state.openedApps[id]) {
            ...
            return {
              ...
              openedAppsArr: [
                ...state.openedAppsArr.filter(
                  (openedApp) => openedApp.id !== id
                ),
                currentOpenedApp,
              ],
              focusAppId: id,
        ...
        updateDesktopApp(id: string, app: UbuntuApp) {
          return {
            ...state,
      ...
      {
        apps(dispatch, newValue) {
          dispatch({
            type: 'setAppMaps',
            payload: [appArr2Map(newValue)],
          })
        },
      },
    ],
